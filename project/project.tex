...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figures/mk-evals-ui-1.png}
    \caption{The skill page for \texttt{log-digest} before any tests exist. The evaluation section is present but empty}
    \label{fig:ui-before}
  \end{figure}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-3.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-4.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-5.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-6.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-7.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-8.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-9.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/mk-evals-ui-10.png}
