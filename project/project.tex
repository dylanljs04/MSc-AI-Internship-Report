...
This section walks one author, one skill, and one complete evaluation cycle through the browser, using the \texttt{log-digest} skill of Figure~\ref{fig:skill-md} throughout. The flow runs from a skill with no tests at all to a skill page carrying current pass and fail evidence for both dimensions, and each step is anchored to a screenshot.
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-2.png}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-3.png}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-4.png}
  \caption{Invocation results. Triggered versus expected per prompt, with pass and fail at a glance.}
  \label{fig:ui-inv-results}
\end{subfigure}
\caption{The evaluation feature in Maia Knowledge: setup and invocation evaluation (steps 1 to 4).}
\label{fig:ui-invocation}
\end{figure}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-6.png}
  \caption{A quality run in progress. The same panel as (\subref{fig:ui-inv-running}) of Figure~\ref{fig:ui-invocation}, over a longer horizon.}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-7.png}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-9.png}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/mk-evals-ui-10.png}
\end{subfigure}
\caption{The evaluation feature in Maia Knowledge: quality evaluation and publishing (steps 5 to 10).}
\label{fig:ui-quality}
\end{figure}
